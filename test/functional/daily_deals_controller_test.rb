...
class DailyDealsControllerTest < ActionController::TestCase
  ...
  test "should create daily_deal" do
    assert_difference('DailyDeal.count') do
      post :create, daily_deal: { DealerFavorite?: @daily_deal.DealerFavorite?, DealerID: @daily_deal.DealerID, DealerName: @daily_deal.DealerName, DealerType: @daily_deal.DealerType }
    end
  ...
  test "should update daily_deal" do
    put :update, id: @daily_deal, daily_deal: { DealerFavorite?: @daily_deal.DealerFavorite?, DealerID: @daily_deal.DealerID, DealerName: @daily_deal.DealerName, DealerType: @daily_deal.DealerType }
    assert_redirected_to daily_deal_path(assigns(:daily_deal))
  end
